...
function Gifting() {
    return ( <
        ...
        Navbar / >
        <
        img src = "https://www.haldirams.com/media/catalog/tmp/category/gifting_1.jpg" / >
        <
        ...
        <
        GiftCards ClassName = "product-menu"
        imgurl = "https://www.haldirams.com/jeera-sticks-150-gm.html" >
        { " " } <
        /GiftCards>{" "} <
        GiftCards ClassName = "product-menu"
        ...
        /GiftCards>{" "} <
        GiftCards ClassName = "product-menu"
        imgurl = "https://www.haldirams.com/rice-kodubale-150-gm.html" >
        { " " } <
        /GiftCards>{" "} <
        GiftCards ClassName = "product-menu"
        imgurl = "https://www.haldirams.com/salted-peanuts-standy-1730.html" >
        { " " } <
        /GiftCards>{" "} <
        /div>{" "} <
        div className = "Product-group p-5 m-5" >
        ...
        /GiftCards>{" "} <
        GiftCards ClassName = "product-menu"
        imgurl = "https://www.haldirams.com/bengalure-mixture-150gm.html" >
        { " " } <
        /GiftCards>{" "} <
        GiftCards ClassName = "product-menu"
        imgurl = "https://www.haldirams.com/bhujia-sev-jar-1449.html" >
