...
function Sweets() {
  return (
    ...
    <Navbar/>
  <Link to="/">
  <img src="https://www.haldirams.com/media/catalog/tmp/category/Sweets.jpg" className="d-block w-100" id="same" />
  </Link>
<div className='container'>
<h2 class="mt-5 text-center heading-bestseller">Packed Sweet</h2>
<div className='product-group  p-5 m-5'>
    <img src="https://www.haldirams.com/media/catalog/tmp/category/packed_sweets_1.jpg" 
    className="img-savie" />
</div>
<div className='product-group p-5 m-5'>
...
<h2 class="mt-5 text-center heading-bestseller">Exotic Collection</h2>
<div className='product-group  p-5 m-5'>
    <img src="https://www.haldirams.com/media/catalog/tmp/category/exotic_collections.jpg" 
    className="img-savie" />
</div>
...
<h2 class="mt-5 text-center heading-bestseller">Tin Sweets</h2>
<div className='product-group  p-5 m-5'>
    <img src="https://www.haldirams.com/media/catalog/tmp/category/tine_sweets.jpg" 
    className="img-savie" />
</div>
<div className='product-group  p-5 m-5'>
